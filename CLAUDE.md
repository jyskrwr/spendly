...
**Spendly** — a Python/Flask personal expense tracker app, structured as a step-by-step teaching project. Students implement features incrementally across numbered steps (database setup, auth, CRUD, etc.). The landing page, register/login, terms, and privacy routes are already built; everything else is a stub.
